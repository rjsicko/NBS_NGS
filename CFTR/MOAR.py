...
endpoint = "jobs"
job=4696
url = "{}api/{}/{}".format(server, endpoint, job)
job_dir = "/var/www/analysis/" + str(job) + "/"
...
report_output_html = "/home/rocky/{}_test_MOAR.html".format(project_name)
report_output_pdf = "/home/rocky/{}_test_MOAR.pdf".format(project_name)
