...
####    v0.0.1-alpha.7 - it's aggravating me that jobs dont have the batch name... using rest API to get the run name using helper python script
####To Do:
...
function intial_setup() {
    project_id=$(python /var/www/analysis/watched/nys_nbs/auto_3rd_tier_helper.py --job_id "$job_id")
    project_name="${project_id}_3rd-tier_seq_SV"
    project_name_cnv="${project_id}_3rd-tier_CNV"
